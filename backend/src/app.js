...
const contactController = require('./api/common/contacts/contactController');
const accountController = require('./api/common/accounts/accountController');
...
app.use(`${root}/contacts`, auth , contactController);
app.use(`${root}/accounts`, auth , accountController);
app.use(logErrors);
